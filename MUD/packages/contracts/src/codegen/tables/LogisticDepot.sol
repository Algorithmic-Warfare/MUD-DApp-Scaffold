...
library LogisticDepot {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "AWAR", name: "LogisticDepot", typeId: RESOURCE_TABLE });`
   ...
   * @notice Get smartStorageUnitId.
   */
  function _getSmartStorageUnitId(uint256 id) internal view returns (uint256 smartStorageUnitId) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   */
  function setSmartStorageUnitId(uint256 id, uint256 smartStorageUnitId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Set smartStorageUnitId.
   */
  function _setSmartStorageUnitId(uint256 id, uint256 smartStorageUnitId) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   */
  function get(uint256 id) internal view returns (LogisticDepotData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Get the full data.
   */
  function _get(uint256 id) internal view returns (LogisticDepotData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
